...
$sql = "SELECT * FROM coastal_cities WHERE city_slug = :city_slug";
...
$sqlImages = "SELECT * FROM city_images WHERE city_id = :city_id";
...
<section class="images_cities">
    ...
    <div class="hotl">
    <a href="hotels.php?city_slug=<?= urlencode($citySlug) ?>" class="btn">hoteles</a>
    <a href="hotels.php?city_slug=<?= urlencode($citySlug) ?>" class="btn">local dishes</a>
    </div>
    ...
    <div class="gallery">
        <?php if ($images): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>No images available for this city.</p>
        <?php endif; ?>
    </div>
</section>
