...
if (isset($_GET['delete_image_id'])) {
    ...
    $sql = "SELECT image_path FROM city_images_noCoastal WHERE image_id = :image_id"; // ✅ استخدام image_id
    $stmt = $pdo->prepare($sql);
    ...
    if ($image) {
        ...
        $sqlDelete = "DELETE FROM city_images_noCoastal WHERE image_id = :image_id"; // ✅ استخدام image_id
