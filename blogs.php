...
?>
    ...
    <h1>Articles sur le tourisme au Maroc</h1>
        ...
        <?php if (!empty($blogs)): ?>
            <?php foreach ($blogs as $blog): ?>
                <div class="blog-item" id="fade-in">
                    ...
                    <?php else: ?>
                        <img src="uploadeAdmin/default.jpg" alt="Image par défaut" class="blog-image">
                    <?php endif; ?>
                    ...
                    <button class="read-more-btn">suite</button>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
...
<section class="experience">
    ...
    <div class="user-share-experience" id="fade-in">
        <form id="experience-form" method="POST" action="submit_experience.php">
            <label for="user-comment">Votre expérience :</label><br>
            <textarea id="user-comment" name="user_comment" rows="4" placeholder="Partagez votre expérience ici..." required></textarea><br><br>
            <button type="submit">Soumettre votre expérience</button>
        </form>
    </div>
